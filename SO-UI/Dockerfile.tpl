...
CMD haproxy -D -f /opt/haproxy/haproxy.cfg && /usr/sbin/sshd && chown syslog:syslog /var/log/rift/ && /usr/rift/rift-shell -r -i /usr/rift -a /usr/rift/.artifacts -- ./demos/launchpad.py --use-xml-mode
